...
arc::SDLWindow::SDLWindow(unsigned int x_coord, unsigned int y_coord,
...
{
    this->CloseWindow();
    this->m_window = SDL_CreateWindow("Arcade", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED,
                                      x_coord, y_coord, SDL_WINDOW_SHOWN);
    this->m_renderer = SDL_CreateRenderer(this->m_window, -1, SDL_RENDERER_ACCELERATED);
}
